...
<div class="main-banner wow fadeIn" id="top" data-wow-duration="1s" data-wow-delay="0.5s" 
    style="
    background-image: url('../pemanis/assets/images/bg.jpg');
    background-size: cover;
    opacity: initial ;
    ">
    <div class="container">
        <img src="../pemanis/assets/images/bg.jpeg" alt="">
      <div class="row">
        <div class="col-lg-12">
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <h6 style="font-size: 1.5rem; margin-bottom: 20px; color: #ff334c;">Welcome to</h6>
                <img src="../pemanis/assets/images/logo.png" alt="KOPTEL Logo" class="img-fluid mb-3">
                <p style="font-size: 1.1rem; margin-bottom: 20px; color: #333;">KOPTEL merupakan koperasi sekunder di bawah naungan PT. Telkom Indonesia.</p>
                <a href="#contact" class="btn btn-primary btn-lg">Selengkapnya</a>
              </div>
            </div>
            <div class="col-lg-6">
              <!-- New Interactive Card Box -->
              <div class="card mt-4 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.7s">
                <div class="card-header text-center">
                  <h5 class="card-title mb-0">VISI & MISI</h5>
                </div>
                <div class="card-body">
                  <h6 class="card-subtitle mb-2">VISI</h6>
                  <p class="card-text mb-4">KOPTEL melaksanakan kegiatannya berdasarkan pada semangat Koperasi yaitu : Kerjasama, Kekeluargaan, dan Gotong Royong serta menginduk kepada kebijakan manajemen perusahaan yaitu PT. TELKOM.</p>
                  <hr>
                  <h6 class="card-subtitle mb-2">MISI</h6>
                  <ul class="custom-list">
                    <li><i class="bi bi-dot"></i> Mengutamakan penghimpunan dan penyaluran pembiayaan.</li>
                    <li><i class="bi bi-dot"></i> Mewujudkan pertumbuhan dan keuntungan yang berkesinambungan.</li>
                    <li><i class="bi bi-dot"></i> Menyediakan produk dan layanan yang mengedepankan etika sesuai dengan prinsip syariah.</li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="left-image wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
            <img src="../pemanis/assets/images/about-left-image.png" alt="person graphic">
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                  <div class="icon">
                    <img src="../pemanis/assets/images/service-icon-01.png" alt="reporting">
                  </div>
